        ...
        <>
            <div className='overflow-y-hidden'>
                ...
                <div className="py-4 flex items-center justify-between 2xl:mx-[8rem] md:mx-[2rem] sm:mx-[2rem] xs:mx-[2rem] xxs:mx-[2rem]">
                    <div>
                        <button className='text-black cairo_semibold_title border-2 text-md bg-white py-2 px-6 hover:text-white hover:bg-black active:text-black/100 active:bg-white/100 rounded-xl'>
                            انضم لنا
                        </button>
                    </div>
                    <div>
