  ...
  return (
    <>
      <div className=" bg-teal-300/[0.2] w-full h-full flex-col absolute z-10 mx-auto  top-0 bottom-0 justify-center flex align-center">
        ...
        <h4 className="cairo_semibold_title text-white text-2xl flex justify-center my-4">
          لمساعدة الارض يجب علينا اولا ان نعلم
        </h4>
        <h4 className="cairo_semibold_title text-white text-2xl flex justify-center">
