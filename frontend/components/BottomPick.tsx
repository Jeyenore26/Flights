    ...
    <div className=" fixed bottom-0 right-0 p-3 m-4  ">
      ...
      {on && (
        <>
          ...
          <div className="my-5 m-3 border-[2px] 2xl:hidden xl:hidden lg:hidden md:hidden border-full rounded-full p-1 hover:text-black/50 hover:border-black/40 active:text-black/90 active:border-black/80 border-gray-700">
