...
function Goals() {
  return (
    <section className="goalssection py-40 translate-y-[30rem]">
            <div className="relative wsection mx-auto">
              <div className="w-[100%] griid">
                ...
                <div className="flex">
                    ...
                    <div className="flex">
                        <p className="flex cairo_regular_title text-lg mx-3">ليس لدينا جميعا رفاهية المشي في كل مكان لكن المركبات هي اكبر حل وسط للهواء ز هذه الانابيب الخلفية على مستوي الشارع</p>
                    </div>
