...
const HomeExplanation = () => {
  return (
    <div id="midTo" className="container1 mt-[1rem] ">
     <div  className=" flex  2xl:flex-row-reverse xl:flex-row-reverse lg:flex-row-reverse md:flex-row-reverse sm:flex-col-reverse xs:flex-col=reverse xxs:flex-col-reverse 2xl:mr-[10rem] xl:mr-[10rem] lg:mr-[10rem] md:mr-[10rem] text-left">
      ...
      <img
        ...
        alt=""
        className=" shadow-lg shadow-black imagea md:mt-[-40px] mx-auto w-[50rem] h-[30rem] image-1"
      />
      </div>
...
<img
  src="https://s3-us-west-1.amazonaws.com/contentlab.studiod/getty/9453205e492449dc8a8bc4da86362dcd.jpg"
  alt=""
  className=" shadow-lg shadow-black imagea z-10  rounded-md xxs:mt-[-30px] xxs:w-[50rem] xxs:h-[24rem] 2xl:w-[35rem]  2xl:h-[25rem] xl:w-max lg:w-max md:w-max  2xl:mt-[-80px] xl:mt-[-80px] md:mt-[-80px] sm:mt-[-80px] "/>
  ...
  <p className=" text-[22px] cairo_regular_title mt-20 mr-20 overflow-hidden ">الخلابالخلابالخلابالخلابالخلابالخلاب جمال الطبيعة الخلاب  الخلابالخلابالخلابالخلابالخلابالخلاب جمال الطبيعة الخلاب</p>
    ...
    {/*Problem 3  */}
    <div dir="rtl" className="flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-col sm:flex-col xxs:flex-col justify-between  2xl:mx-20 xl:mx-20 lg:mx-20 md:mx-20 sm:mx-10 xs:mx-10 xxs:mx-[1rem]">
      <div className="py-[10rem] mt-32">
        <span className="cairo_bold_title text-2xl">هناك 9 طرق كثيرة لنساعد الارض</span>
        <div className="flex">
        <p  className="w-16  mt-[3rem] border-t-[3px] border-[#81c132] "></p>

        </div>
        <span className="cairo_regular_title text-xl flex 2xl:ml-[10rem] xl:ml-[10rem] lg:ml-[10rem] md:ml-[10rem]">انا لا اقول انه انا احد ابطال الطبيعة ولا الرجل الصحيح وكن انا اريد مساعدة بيتي و عالمي  من التدهور القريب  انا لا اقول انه انا احد ابطال الطبيعة ولا الرجل الصحيح وكن انا اريد مساعدة بيتي و عالمي  من التدهور القريب </span>
      </div>
      <div className="flex ">
        <div> 
        <img
  src="https://s3-us-west-1.amazonaws.com/contentlab.studiod/getty/9453205e492449dc8a8bc4da86362dcd.jpg"
  alt=""
  className="  imagea z-20   2xl:mt-[7rem] xl:mt-14 lg:mt-20 absolute xxs:mr-[-10px] 2xl:mr-[15rem] xl:mr-[15rem] lg:mr-[8rem] md:mr-[10rem] 2xl:w-[30rem] xl:w-[24rem] lg:w-[18rem] opacity-90  2xl:h-[27rem] "/>
        </div>
  ...
  alt=""
  className="  imagea  absolute 2xl:w-[30rem] xl:w-[25rem] md:mt-32 xxs:mr-[-10px]  xl:h-[15rem] lg:w-[25rem] lg:mt-[30rem] lg:h-[15rem] lg:mr-[-30rem]  2xl:mr-[-40rem] xl:mr-[-40rem]  mt-[24rem] z-10 opacity-90 2xl:h-[20rem]"/>
        </div>
      </div>
    </div>
    </div>
