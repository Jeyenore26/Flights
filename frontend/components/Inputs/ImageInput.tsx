...
function ImageInput({
  ...
  return (
    <div dir="rtl" className="">
      ...
      <input
        className={`${image} ? "text-titleText" : "text-transparent"} mt-2  w-full file:hidden   border border-placeholderText py-2 pl-2 cursor-pointer focus:border-transparent  focus:ring-main 
              block
              font-small
