...
function Sphere() {
  const [colorMap, normalMap, cloudMap, specularMap] = useLoader(
    TextureLoader,
    [
      "/8k_earth_daymap.jpg",
  ...
  return (
    <>
      ...
      <Stars
        ...
        fade={true}
      />
      <mesh ref={cloudRef} scale={2} dispose={null} geometry={sphere}>
        <meshPhongMaterial
          map={cloudMap}
          opacity={0.4}
          depthWrite={true}
      ...
      <mesh ref={earthRef} scale={2} dispose={null} geometry={sphere}>
